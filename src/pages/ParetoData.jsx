...
function Pareto() {
  ...
  const fetchData = async () => {
    let response1 = await axios.get("http://10.126.15.138:8002/part/line1", {
      params: {
        date: date,
      },
    });
    ...
    let response2 = await axios.get("http://10.126.15.138:8002/part/line2", {
      params: {
        date: date,
      },
    });
    ...
    let response3 = await axios.get("http://10.126.15.138:8002/part/line3", {
      params: {
        date: date,
      },
    });
