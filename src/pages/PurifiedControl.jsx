    ...
    export default function PurifiedControl() {
        ...
        const fetchPurified = async () => {
            let response = await axios.get(
              "http://10.126.15.138:8002/part/PurifiedWater",
              {
                params: {
                  area: purifiedArea,
                  start: startDate,
            ...
            } else if (purifiedArea === "cMT-BWT_FT270A_6.1_data"){
              var multipliedData = response.data.map((data) => ({
                label: data.label,
                y: data.y,
                x: data.x,
            ...
            <div>
                ...
                <div>
                    ...
                    <Select placeholder="Select Parameter" onChange={getPurifiedArea}>
                        ...
                        <option value="cMT-BWT_FT270A_6.1_data">FT270A 6.1</option>
                    </Select>
                </div>
                <div>
                <h2>Start Time</h2>
